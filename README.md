...
*Windows PowerShell alternatives: `npm run setup:win`, `clean:win`, `reset:win`, `doctor:win`.*
...
| Quick Open File Search | `Cmd/Ctrl + P` *(Blocked on Welcome Screen)* |
| Command Palette | `Cmd/Ctrl + Shift + P` *(Blocked on Welcome Screen)* |
